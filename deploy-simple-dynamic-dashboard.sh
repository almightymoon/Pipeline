...
echo "========================================="
echo "Deploying Simple Dynamic Real Data Dashboard"
echo "========================================="
...
DASHBOARD_JSON=$(cat monitoring/simple-dynamic-dashboard.json)

# Update template variables with current repository
DASHBOARD_JSON=$(echo "$DASHBOARD_JSON" | jq --arg repo_name "$REPO_NAME" '
...
echo "Importing simple dynamic real data dashboard..."
